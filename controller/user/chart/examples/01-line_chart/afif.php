<meta charset="utf-8">
    ...
    <!-- Custom Fonts -->
    <link href="/final/advancedasli/vendor/fortawesome/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    <div class="box-header">
       <h3><a href="./afifprint.php"><span class="fa fa-print" style="font-size: 30px"></span></a></h3>
     </div>
<?php 
